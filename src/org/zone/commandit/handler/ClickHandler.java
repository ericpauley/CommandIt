...
public class ClickHandler {
	...
	public void copySign() {
		...
		LuaCode clone = plugin.getCodeBlocks().get(location)
				.clone(player.getName());
	...
	public boolean onInteract(Action action) {
		...
		if (state != null) {
			...
			case BATCH_TOGGLE:
				...
				break;
			/*
			 * case REDSTONE: redstoneToggle(false); break; case BATCH_REDSTONE:
			 * redstoneToggle(true); break;
			 */
			default:
